...
| GET | `/api/monitoring/system` | System metrics จาก Prometheus |
| GET | `/api/monitoring/containers` | Container metrics |
| GET | `/api/monitoring/website` | Website metrics |
| POST | `/api/monitoring/webhook` | Alertmanager webhook |
...
| `/admin/monitoring` | หน้า monitoring แบบ real-time |
