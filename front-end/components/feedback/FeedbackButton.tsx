    ...
    return (
        <>
            <button
                ...
                className={`fixed bottom-4 sm:bottom-6 ${positionClasses[position]} z-50 p-3 sm:p-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 group`}
                title="ส่ง Feedback"
            >
